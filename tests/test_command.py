...
def test_add_general_error(capfd):
    ...
    with patch('app.operation.operations.add', side_effect=ValueError("Test error")):
        command = Add()
        command.execute("5", "3")
        out, _ = capfd.readouterr()
...
def test_subtract_general_error(capfd):
    ...
    with patch('app.operation.operations.subtract', side_effect=ValueError("Test error")):
        command = Subtract()
        command.execute("5", "3")
        out, _ = capfd.readouterr()
...
def test_multiply_general_error(capfd):
    ...
    with patch('app.operation.operations.multiply', side_effect=ValueError("Test error")):
        command = Multiply()
        command.execute("5", "3")
        out, _ = capfd.readouterr()
...
def test_divide_general_error(capfd):
    ...
    with patch('app.operation.operations.divide', side_effect=ValueError("Test error")):
        command = Divide()
        command.execute("5", "3")
        out, _ = capfd.readouterr()
